package ru.ci.admin.repository;

import ru.ci.admin.CiadminApp;
import ru.ci.admin.config.Constants;
import ru.ci.admin.config.audit.AuditEventConverter;
import ru.ci.admin.domain.PersistentAuditEvent;
...
import static ru.ci.admin.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
